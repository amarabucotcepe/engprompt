...
<section id="missoes" class="my-12 md:my-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <button id="btn-missao-1" data-mission="1"
            ...
            <p class="font-medium text-blue-700">O Dilema da Merenda</p>
            <p class="text-sm text-gray-600 mt-2">Crise de gestão e logística na entrega da merenda escolar no
                interior.</p>
        </button>
        ...
        <button id="btn-missao-4" data-mission="4"
            class="mission-card border-2 border-transparent text-left bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            <span class="text-2xl block mb-2">🟠</span>
            <h4 class="text-xl font-semibold text-gray-900 mb-1">Missão 04</h4>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const missions = {
            "1": {
                title: "🔴 Missão 01: O Dilema da Merenda",
                context: "O Governo enfrenta uma crise de imagem e gestão. As escolas do interior relatam atrasos sistemáticos na entrega da merenda escolar. A imprensa cobra respostas e o Governador exige um plano em 24h.",
                challenge: [
                    "<strong>Diagnosticar</strong> as causas prováveis (logística, contratual, climática).",
                    "<strong>Propor</strong> um plano de ação imediato e um estrutural.",
                    "<strong>Redigir</strong> um Parecer Técnico (1 pág) e um Resumo Cidadão."
                ],
                focus: "<em>Chain of Thought</em> para desdobrar a complexidade logística."
            },
            "2": {
                title: "🔵 Missão 02: Operação Trânsito Zero",
                ...
                data: [
                    "`acidentes-de-transito-com-vitimas-2023`",
                    "`ciclovias-ciclofaixas-estacoes-de-aluguel-de-bikes-e-rotas`",
                    "`velocidade-das-vias-quantitativo-por-velocidade-media`",
                    "`registro-das-infracoes-de-transito`"
                ],
                challenge: [
                    "<strong>Diagnóstico:</strong> Simular análise de dados cruzando locais de acidentes x excesso de velocidade.",
                    "<strong>Solução:</strong> Propor intervenções físicas rápidas.",
                    "<strong>Entrega:</strong> Nota Técnica justificando redução de velocidade + Post para Redes Sociais."
                ],
                focus: "<em>Data Analysis Prompting</em> (simulação de análise de dados)."
            },
            "3": {
                title: "🟢 Missão 03: Guerra às Arboviroses",
                ...
                data: [
                    ...
                    "`destinacao-de-residuos-solidos` ou `roteiro-de-coleta`",
                    "`relacao-das-favelas-corticos-e-loteamentos-irregulares`"
                ],
                challenge: [
                    "<strong>Correlação:</strong> Usar a IA para raciocinar sobre a sobreposição geográfica (Doença x Lixo x Vulnerabilidade).",
                    "<strong>Ação:</strong> Planejar um 'Dia D' (Saúde + Limpeza).",
                    "<strong>Entrega:</strong> Plano de Ação Intersetorial + Roteiro para Carro de Som (linguagem popular)."
                ],
                focus: "<em>CoT</em> para planejamento logístico e <em>Style Transfer</em> (técnico para popular)."
            },
            "4": {
                title: "🟠 Missão 04: Inverno Seguro",
                ...
                data: [
                    ...
                    "`obras-publicas`",
                    "`unidades-educacionais-no-municipio`",
                    "`despesas-orcamentarias`"
                ],
                challenge: [
                    "<strong>Priorização:</strong> Criar uma 'Matriz de Decisão' na IA cruzando histórico de riscos e presença de equipamentos públicos.",
                ...
                focus: "<em>Role Prompting</em> (Jurídico/Financeiro) e <em>Logical Prompting</em>."
            }
        };
        ...
        missionButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                if (data.data) {
                    dataListHtml = `
                        <h4 class="text-lg font-semibold text-gray-800 mt-4 mb-2">Dados de Referência (Simulados):</h4>
                        <div class="flex flex-wrap gap-2">
                            ${data.data.map(item => `<code class="text-sm bg-gray-100 text-gray-700 px-2 py-1 rounded">${item}</code>`).join('')}
                        </div>
                    `;
                }
