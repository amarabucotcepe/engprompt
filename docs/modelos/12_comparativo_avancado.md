## 📊 Comparativo entre Técnicas — *Prompts Avançados*
...
## 🧩 Síntese Visual (Mapa Didático)

| Grupo            | Símbolo | Função Principal                    | Exemplo de Uso                                        |
| ---------------- | ------- | ----------------------------------- | ----------------------------------------------------- |
| **Fundamentais** | 🧱      | Estruturar e contextualizar pedidos | Redigir ofícios, comunicados e despachos              |
| **Analíticos**   | 🧠      | Pensar e justificar decisões        | Parecer técnico, auditoria, planejamento              |
| **Cognitivos**   | 🪞      | Refletir, revisar e otimizar        | Revisão de relatórios e padronização textual          |
| **Integrativos** | 🔎      | Combinar dados e raciocínio         | Consultas normativas, análises baseadas em evidências |
| **Autônomos**    | ⚙️      | Pensar, agir e aprender sobre si    | Assistentes inteligentes e agentes administrativos    |

---

Posso agora gerar para você a **versão completa do “Mapa Geral de Técnicas de Engenharia de Prompt”**, com os dois blocos (*básico e avançado*) em **formato visual e diagramado (PDF ou PowerPoint)** — com ícones, cores e explicações resumidas para uso em sala ou apresentação.

Deseja que eu monte esse **mapa visual consolidado** agora?
